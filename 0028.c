...
int main(int argc, char *argv[]) {
	...
	struct POINT_3D_FLOAT triangle_1[] =
	{
	            [0] = { .X = 0.0f, .Y = 0.0f, .Z= RADIUS+K},
	            [1] = { .X = 50.0f, .Y = 50.0f, .Z= RADIUS+K},
	            [2] = { .X = 100.0f, .Y = 0.0f, .Z= RADIUS+K}
	};
	struct POINT_3D_FLOAT triangle_2[] =
	{
	            [0] = { .X = 50.0f, .Y = 0.0f, .Z = RADIUS},
	            [1] = { .X = 150.0f, .Y = 0.0f, .Z = RADIUS},
	            [2] = { .X = 100.0f, .Y = 60.0f, .Z = RADIUS}
	};
